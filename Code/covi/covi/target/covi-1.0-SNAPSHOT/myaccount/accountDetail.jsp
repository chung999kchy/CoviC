<%-- 
    ...
    Created on : Apr 16, 2021, 9:22:38 AM
    Author     : CHUNG
--%>
        ...
        <div class="menu-list">
            <form action="update" method="POST" id="form-user" class="form-user">
                <div class="form-group">
                    ...
                    <input id="ten_dang_nhap" class="form-control" name="ten_dang_nhap" type="text" readonly value="${userLogin.getTenDangNhap()}">
                    <span class="form-message"></span>
                </div>

                <div class="form-group">
                    <label for="ten_nguoi_dung" class="form-label">Tên người dùng</label>
                    <input id="ten_nguoi_dung" class="form-control" name="ten_nguoi_dung" type="text" value="${userLogin.getTenNguoiDung()}">
                    <span class="form-message"></span>
                </div>

                <div class="form-group">
                    <label for="loai_tai_khoan" class="form-label">Loại tài khoản</label>
                    <input id=loai_tai_khoan" class="form-control" name="loai_tai_khoan" type="text" readonly value="${userLogin.getLoaiTaiKhoan().getTenLoaiTaiKhoan()}">
                    <span class="form-message"></span>
                </div>

                <div class="form-group">
                    <label for="phone" class="form-label">Số điện thoại</label>
                    <input id="phone" class="form-control" name="phone" type="text" value="${userLogin.getSoDienThoai()}">
                    <span class="form-message"></span>
                </div>
                <button class="form-submit" type="submit">Lưu</button>
            </form>
